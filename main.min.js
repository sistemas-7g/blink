			...
			case "exercise":
				...
				$(".window.exercise iframe").load(function() {
					...
					setTimeout(function(){
						...
						if(h<10 && document.getElementById('exercise-iframe').contentWindow.getElementsByClassName('content-wrapper').length > 0){
							// Si el body del iframe no tiene height y hay un .content-wrapper
							h = document.getElementById('exercise-iframe').contentWindow.getElementsByClassName('content-wrapper').offsetHeight;
						}else{
							h = $(document).height();
						}
						iResize(w, h);
