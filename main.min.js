		...
		switch (t.type) {
			case "exercise":
				...
				*/
				...
				var ejercicios = [31975728, 31990584, 31990585];

				var blink_exercise_id = ejercicios[ ($('.layer'+t.id).index('.exercise') % ejercicios.length) ];
				...
				$(".window.exercise iframe").load(function() {
					...
					setTimeout(function(){
						...
						var w = 930;
						var h = document.getElementById('exercise-iframe').contentWindow.document.body.offsetHeight;
...
var Modal = function(e, t) {
	function r(e) {
		...
		if ($(".modal-widget").length > 0 && !$('.modal-widget').hasClass('modal-audio-player') ) {
			//Removing listener for audio player to avoid drag conflict
