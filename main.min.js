		...
		switch (t.type) {
			case "exercise":
				...
				$(".window.exercise iframe").load(function() {
					...
					setTimeout(function(){
						iResize( document.getElementById('exercise-iframe').contentWindow.document.body.offsetWidth+6, document.getElementById('exercise-iframe').contentWindow.document.body.offsetHeight );
					},50);
