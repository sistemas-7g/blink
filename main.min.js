	...
	$(".document-viewer").on("click_mark", function(e, t) {
		...
		switch (t.type) {
			case "exercise":
				...
				/*id hardcoded by @estebanlopeza*/
				var blink_exercise_id = 31975729;
				var exerciseURL = getActivityURL(blink_exercise_id);

				console.log(exerciseURL);
			
				$(".window.exercise").fadeIn();
				$(".window.exercise iframe").remove();
				$(".window.exercise").append('<iframe style="display:none;" frameborder="0" scrolling="no" id="exercise-iframe" src="' + exerciseURL + '"></iframe>');
...
/*
				    ...
				    var iSource = document.getElementById('exercise-iframe').src;
				    document.getElementById('exercise-iframe').src = '';
				    document.getElementById('exercise-iframe').src = iSource;

						var w = document.getElementById('exercise-iframe').contentWindow.document.body.offsetWidth+6,
							h = document.getElementById('exercise-iframe').contentWindow.document.body.offsetHeight;


						if(h < 10 && document.getElementById('exercise-iframe').contentWindow.document.getElementsByClassName('content-wrapper').length > 0){
							// Si el body del iframe no tiene height y hay un .content-wrapper
							h = document.getElementById('exercise-iframe').contentWindow.document.getElementsByClassName('content-wrapper').offsetHeight;
						}else{
...
*/
					setTimeout(function(){
						...
						if(false && h < 10 && document.getElementById('exercise-iframe').contentWindow.document.getElementsByClassName('content-wrapper').length > 0){
							// Si el body del iframe no tiene height y hay un .content-wrapper
							h = document.getElementById('exercise-iframe').contentWindow.document.getElementsByClassName('content-wrapper')[0].offsetHeight;
						}else{
							// tomo el alto del frame contenedor
							h = document.body.offsetHeight;
						}
